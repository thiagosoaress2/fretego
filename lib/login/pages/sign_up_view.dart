                          ...
                          onPressed: (){
                            ...
                            if(btnIsEnable==true){
                              ...
                              if (_formKey.currentState.validate()) {
                                if (passWordConfirmIsOk==false || passwordIsOk==false){
                                  ...
                                  if (passwordController.text.length==6){
                                    ...
                                    newAuthService.SignUpNewUserWithEmailAndPassword(userModel, nameController.text, emailController.text, passwordController.text, () {_onSucess(); }, () {_onFailure();});
