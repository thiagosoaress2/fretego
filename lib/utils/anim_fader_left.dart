...
class EntranceFaderLeft extends StatefulWidget {
  ...
  @override
  EntranceFaderLeftState createState() {
    return new EntranceFaderLeftState();
  }
}

class EntranceFaderLeftState extends State<EntranceFaderLeft>
