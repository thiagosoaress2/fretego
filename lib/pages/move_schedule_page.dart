...
class _MoveSchedulePageState extends State<MoveSchedulePage> {
            ...
            body: Container(
              ...
              child: Stack(
                children: [
                  ...
                  moveModel.ActualPage=='itens' ? Page1SelectItens(heightPercent, widthPercent, widget.userId)
                  :moveModel.ActualPage=='obs' ? Page2Obs(heightPercent, widthPercent, widget.userId)
                  : moveModel.ActualPage=='truck' ? Page3Truck(heightPercent, widthPercent, widget.userId)
                  : moveModel.ActualPage=='end' ? Page4Enderecos()
                  : moveModel.ActualPage=='trucker' ? Page5Trucker(heightPercent, widthPercent, widget.userId)
                  : moveModel.ActualPage=='data' ? Page6Data(heightPercent, widthPercent, widget.userId)
                  : Container(),
                  ...
                  //float action button
                  moveModel.ActualPage!='itens' && moveModel.ActualPage != 'end' && moveModel.ActualPage!='trucker' && moveModel.ActualPage!='data' ?
                  Positioned(
                      bottom: 15.0,
                      right: 10.0,
                      child: FloatingActionButton(
                        onPressed: (){
                          ...
                          if(moveModel.ActualPage=='itens'){
                            ...
                            if(moveModel.itemsSelectedCart.length==0 || moveModel.itemsSelectedCart.length == null){
                               MyBottomSheet().settingModalBottomSheet(context, 'Ops...', 'Lista vazia', 'Nenhum item escolhido para a mudança.', Icons.info, heightPercent, widthPercent, 0, true);
                            } else {
                            ...
                            SharedPrefsUtils().savePsInShared(moveModel.moveClass.ps);
                            moveModel.changePageForward('truck', 'Obs', 'Veículo');

                          } else if(moveModel.ActualPage=='truck'){
                            if(moveModel.carInMoveClass!=null){
                              moveModel.changePageForward('end', 'Carro', "Endereço");

                            } else {
                              MyBottomSheet().settingModalBottomSheet(context, 'Ops...', 'Sem veículo selecioando', 'Nenhum veículo escolhido ainda.', Icons.info, heightPercent, widthPercent, 0, true);
                            }
                          } else if(moveModel.ActualPage=='end'){
                              moveModel.changePageForward('hora', 'Endereço', 'Horários');
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  moveModel.ActualPage!='final' ? SizedBox(width: widthPercent*0.09,) : SizedBox(),
                  moveModel.ActualPage!='final' ? Column(
                    children: [
                      Container(
                        child: Icon(Icons.airport_shuttle, color: moveModel.ActualPage=='itens' || moveModel.ActualPage=='obs' ? Colors.blue : Colors.white,),
                        decoration: new BoxDecoration(
                          shape: BoxShape.circle,// You can use like this way or like the below line
                          color: moveModel.ActualPage=='itens'  || moveModel.ActualPage=='obs' ? Colors.white : Colors.blue,
                          border: Border.all(
                            color: Colors.white,
                            width: 2.0, //                   <--- border width here
                          ),
                  ...
                  moveModel.ActualPage!='final' ? Column(
                    children: [
                      Container(
                        child: Icon(Icons.home, color: moveModel.ActualPage=='itens' || moveModel.ActualPage=='obs' || moveModel.ActualPage=='truck' ? Colors.blue : Colors.white,),
                        decoration: new BoxDecoration(
                          shape: BoxShape.circle,// You can use like this way or like the below line
                          color: moveModel.ActualPage=='itens' || moveModel.ActualPage=='obs' || moveModel.ActualPage=='truck' ? Colors.white : Colors.blue,
                          border: Border.all(
                            color: Colors.white,
                            width: 2.0, //                   <--- border width here
                          ),
                  ...
                  moveModel.ActualPage!='final' ? Column(
                    children: [
                      Container(
                        child: Icon(Icons.people_alt_sharp, color: moveModel.ActualPage=='itens' || moveModel.ActualPage=='obs' || moveModel.ActualPage=='truck' || moveModel.ActualPage=='end' ? Colors.blue : Colors.white,),
                        decoration: new BoxDecoration(
                          shape: BoxShape.circle,// You can use like this way or like the below line
                          color: moveModel.ActualPage=='itens' || moveModel.ActualPage=='obs' || moveModel.ActualPage=='truck'  || moveModel.ActualPage=='end' ? Colors.white : Colors.blue ,
                          border: Border.all(
                            color: Colors.white,
                            width: 2.0, //                   <--- border width here
                          ),
                  ...
                  moveModel.ActualPage!='final' ? Column(
                    children: [
                      Container(
                        child: Icon(Icons.schedule_outlined, color: moveModel.ActualPage=='itens' || moveModel.ActualPage=='obs' || moveModel.ActualPage=='truck' || moveModel.ActualPage=='end' || moveModel.ActualPage=='trucker' ? Colors.blue : Colors.white,),
                        decoration: new BoxDecoration(
                          shape: BoxShape.circle,// You can use like this way or like the below line
                          color: moveModel.ActualPage=='itens' || moveModel.ActualPage=='obs' || moveModel.ActualPage=='truck' || moveModel.ActualPage=='end' || moveModel.ActualPage=='trucker' ? Colors.white : Colors.blue,
                          border: Border.all(
                            color: Colors.white,
                            width: 2.0, //                   <--- border width here
                          ),
  ...
  Widget customFakeAppBar(MoveModel moveModel, BuildContext context){
    ...
    void _customBackButton(){
      ...
      if(moveModel.ActualPage=='itens'){
        ...
        moveModel.changePageBackward('trucker', 'carro', 'Profissional');
      }
  ...
  void _topAnimScroll(MoveModel moveModel, double widthPercent){
    ...
    _TopAnimcrollController.animateTo(moveModel.Offset, duration: Duration(milliseconds: 450), curve:Curves.easeInOut);
