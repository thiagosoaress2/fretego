  ...
  Widget build(BuildContext context) {
    return ScopedModelDescendant<MoveModel>(
        builder: (BuildContext context, Widget child, MoveModel moveModel){
          ...
          return _buildBody(moveModel, context);
    },
    );
  }

  Widget _buildBody(MoveModel moveModel, BuildContext context){
    ...
    return Container(
      ...
      child: Stack(
        children: [
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: RaisedButton(
                                  color: moveModel.moveClass.carro == null ? CustomColors.yellow : CustomColors.blue,
          ...
          if(moveModel.moveClass.carro != null) _nextButton(moveModel),
